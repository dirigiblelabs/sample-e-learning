...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'e-learning.Classes.Classes.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('e-learning.Classes.Classes.refresh', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '../../../../../../../../../../services/v4/js/e-learning/api/Classes/Classes.js';
