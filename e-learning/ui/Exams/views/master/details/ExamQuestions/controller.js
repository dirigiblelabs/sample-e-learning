...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'e-learning.Exams.ExamQuestions.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('e-learning.Exams.ExamQuestions.refresh', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '../../../../../../../../../../services/v4/js/e-learning/api/Exams/ExamQuestions.js';
