...
var dao = require("e-learning/data/dao/Exams/ExamQuestions");
var http = require("e-learning/api/http");
...
rs.service()
	...
	.resource("{id}")
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound("ExamQuestions not found");
			}
		})
		.produces(["application/json"])
		.catch(function(ctx, error) {
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/e-learning/api/ExamQuestions.js/" + entity.Id);
